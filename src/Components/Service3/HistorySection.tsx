              ...
              <div className="row">
                <div className="col-lg-6 col-md-6 mb-4">
                  <div className="history-box-content">
                    ...
                    <p>
                      Marina Digitals was founded with a vision to revolutionize the
                ...
                <div className="col-lg-6 col-md-6 mb-4">
                  <div className="history-box-content">
                    ...
                    <p>
                      Building on our success, Marina Digitals expanded our service
                ...
                <div className="col-lg-6 col-md-6 mb-4">
                  <div className="history-box-content">
                    ...
                    <p>
                      Marina Digitals formed strategic partnerships and collaborations with
