...
const testimonials = [
  {
    content: `"I can't say enough about the incredible results we've achieved with Marina Digitals. Their SEO expertise has catapulted our website to the top of search engine rankings, resulting in a significant increase in organic traffic and leads. I highly recommend Marina Digitals to any business looking to boost their visibility and drive growth online."`,
    name: "Anderson Belly",
