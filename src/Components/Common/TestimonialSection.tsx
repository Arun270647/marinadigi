...
const testimonials: Testimonial[] = [
  ...
  {
    id: 2,
    text: "We've been partnering with Marina Digitals for over a year now, and the results speak for themselves. Their comprehensive digital marketing solutions have helped us achieve measurable growth.",
    author: "David M.",
    rating: 5,
    authorLink: "/team",
    logoSrc: "src/assets/img/icons/google1.svg",
